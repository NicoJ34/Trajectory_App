# Test Plan — Sprint 2 — Onboarding + Create Objective (REQ-02)

## Setup
- `pnpm --filter web dev` → http://localhost:3000
- Vider l'IndexedDB entre chaque test : DevTools → Application → Storage → Clear site data
